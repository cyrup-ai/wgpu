...
use super::{
    Block, BlockContext, Dimension, Error, Instruction, LocalType, LookupType, NumericType,
    ResultMember, WrappedFunction, Writer, WriterFlags, index::BoundsCheckResult,
    selection::Selection,
};
use crate::{Statement, arena::Handle, proc::index::GuardedIndex};
            ...
            crate::Expression::Math {
                ...
                let math_op = match fun {
                    ...
                    Mf::CountLeadingZeros => {
                        ...
                        if width != 4 {
                            unreachable!(
                                "This is validated out until a polyfill is implemented. https://github.com/gfx-rs/wgpu/issues/5276"
                            );
                        };
